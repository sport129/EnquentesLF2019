...
@section('titulo')
<p class="navbar-brand">Administração - Cadastro de Usuário</p>
@endsection
        ...
        <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
            ...
            <div class="form-group">
                ...
                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name"
                    value="{{ old('name') }}" placeholder="Digite seu Usuário">
                @if ($errors->has('name'))
            ...
            <div class="form-group">
                <label for="password-confirm">{{ __('Confirm Sua Senha') }}</label>
